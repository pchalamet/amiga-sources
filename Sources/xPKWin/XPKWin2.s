...
Display_Packer_Mode
	...
	move.w #109+11*8,d0			efface l'ancien Mode Info
	move.w #81,d1
	add.w Win_Top(a5),d1
	move.w #109+11*8+8*8,d2
	move.w #89,d3
	add.w Win_Top(a5),d3
	move.l a2,a1
	CALL RectFill
...
.no_query
	lea NoInfoOnModeText(pc),a0		bou.. une erreur !
	move.l a2,a1
...
ListViewSelectedSet_Tags
	dc.l GTLV_Labels,Selected_List
	dc.l TAG_DONE
...
NoInfoOnPackerText	dc.b "Can't get information for this packer."
NoInfoOnPacker_Size=*-NoInfoOnPackerText
NoInfoOnModeText	dc.b "Can't get mode name"
NoInfoOnMode_Size=*-NoInfoOnModeText
