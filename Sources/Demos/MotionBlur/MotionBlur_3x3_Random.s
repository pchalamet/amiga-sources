...
Modify_Chunky_Picture
	...
	move.w #PICTURE_Y-1,d4
.loop_y
	move.l a1,a2
	move.w #PICTURE_X-1,d5
.loop_x
* on génère un nombre aléatoire entre 0 et 31
	bsr random
	and.w #$7c00,d0
	move.w d0,(a2)
