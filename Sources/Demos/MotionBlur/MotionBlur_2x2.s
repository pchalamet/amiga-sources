...
.skip	cmp.w #NB_COLONNES*PIXEL_SIZE_X,d1
...
Build_One_Coplist
	...
	move.l #(color00<<16)|$000,(a0)+
	move.l #($00dffffe)|(($2e-PIXEL_SIZE_Y-2)<<24),(a0)+
...
Build_Line
	...
	moveq #32-1,d0				couleurs de 1 à 31
...
Build_Colors2
	...
	move.l d7,(a0)+				couleurs de 0 à 14
	moveq #32-1,d0
	move.l #color00<<16,d1
Build_Colors3
	move.l d1,(a0)+
