...
.wait_blitter
	...
	clr.w bplcon1(a6)			pas de decalage
	...
	move.w #$87e0,dmacon(a6)		nasty blitter bpl cop blit spr
...
display_Giana
	movem.w giana_PositionX(pc),d0-d1
	moveq #23,d2
	lea spr,a0
	bsr put_sprite

	move.l #spr,spr0ptH(a6)
	move.l #blk_spr,spr1ptH(a6)
	move.l #blk_spr,spr2ptH(a6)
	move.l #blk_spr,spr3ptH(a6)
	move.l #blk_spr,spr4ptH(a6)
	move.l #blk_spr,spr5ptH(a6)
	move.l #blk_spr,spr6ptH(a6)
	move.l #blk_spr,spr7ptH(a6)
	rts
...
coplist
	...
	dc.w color12,$0BBB,color13,$0F70,color14,$0800,color15,$0F00
 	dc.w color17,$0F00,color18,$000F,color19,$0FFF
	dc.l $fffffffe
