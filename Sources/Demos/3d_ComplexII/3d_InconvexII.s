...
Do_3d
	...
	movem.l log_screen(pc),d0/d1	init ptr vidéos dans les coplists
	addq.l #7,d0
	and.l #-8,d0
	addq.l #7,d1
	and.l #-8,d1
...
Main_Prg
	lea my_scene(pc),a0
	move.l a0,Current_Scene-data_base(a5)
...
********************************************************************************
Flip_Screen
	tst.w BlankLeft-data_base(a5)		attend la fin du BlankLimit
	bpl.s Flip_Screen
	...
	movem.l a1-a2/a3-a4,log_coplist-data_base(a5)

	move.w scn_BlankLimit(a0),BlankLeft-data_base(a5)
	lea coplist2_colors-coplist2(a1),a1	installe les couleurs de
	lea scn_ColorMap(a0),a2			la scène
...
Compute_Scene_Matrix
	movem.w scn_Alpha(a0),d0/d1/d2		scn_Alpha,scn_Teta,scn_Phi
...
Find_Visible_Objects
	move.l #ListObjects+l_List,ListObjects_Ptr-data_base(a5)
	clr.w ListObjects+l_Quantity-data_base(a5)

	move.l scn_ListObjects(a0),d7
	beq.s no_find
	movem.w scn_PosX(a0),d0/d1		coordonnées de l'observateur
...
****************** en entrée : a0=*Object                     ******************
****************** en sortie : d0.w=Somme des profondeurs     ******************
******************             a0=*Object                     ******************
******************                                            ******************
********************************************************************************
Rotate_Object
...
no_divs
	...
	move.l a0,(a1)+
	addq.w #1,ListObjects+l_Quantity-data_base(a5)
	addq.l #4,ListObjects_Ptr-data_base(a5)
	rts	
...
.front_color
	move.w face_FrontColor1(a2,d0.w),FaceColor-data_base(a5)
...
Vbl
	...
	subq.w #1,BlankLeft-data_base(a5)	décrémente le BlankLimit
...
Current_Scene		dc.l 0			Ptr sur la scène actuelle
BlankLeft		dc.w 0
