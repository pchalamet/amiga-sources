...
*
	...
	incdir "asm:.s/Multi_Dir_Scroll/Blocks/"
...
* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	move.w (a0)+,d0				nb de (wait+4move)-1
...
* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Degrad_coplist
	dc.w (Degrad_coplist_size/5)-1
colorMSB set $e1e
colorLSB set $f0f+$100-$010
copwait set $2b
	REPT BPL_Y

colorLSB set colorLSB-$100+$010
	IFNE colorLSB=$0ff
colorMSB set colorMSB-$100+$010
colorLSB set $f0f
	ENDC

	dc.b copwait,$01,$ff,$fe
	dc.w bplcon3,$0020
	dc.w color00,colorMSB
	dc.w bplcon3,$0220
	dc.w color00,colorLSB
copwait set copwait+1
	ENDR
...
BackSpr0		ds.b 8+8+8*2+8
BackSpr1		ds.b 8+8+8*2+8
BackSpr2		ds.b 8+8+8*2+8
BackSpr3		ds.b 8+8+8*2+8
BackSpr4		ds.b 8+8+8*2+8
BackSpr5		ds.b 8+8+8*2+8
