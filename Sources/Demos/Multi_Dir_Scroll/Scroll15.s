...
FULL_MERGE=0				SMALL_MERGE si FULL_MERGE=0
	...
	incdir "asm:" "asm:.s/Multi_Dir_Scroll/" "ram:"
...
MIN_X=$f
MIN_Y=0
MAX_X=MAP_WIDTH*BLOCK_X-HERO_X-1
MAX_Y=MAP_HEIGHT*BLOCK_Y-HERO_Y
...
MIN_SCROLL_X=$f
MIN_SCROLL_Y=0
MAX_SCROLL_X=(MAP_WIDTH-HORIZ_BLOCK+1)*16-1
MAX_SCROLL_Y=(MAP_HEIGHT-VERT_BLOCK+1)*16
...
.not_full_screen_part
	...
	lea Map(pc),a0				recherche le pointeur
...
.loop_each_vert_block
	moveq #0,d2				-------------------
	move.b (a0),d2				pointe le bon block
	mulu #BLOCK_WIDTH*BLOCK_Y*BPL_DEPTH,d2	taille d'un block
	lea (a2,d2.l),a4			-------------------
...
.loop_each_horiz_block
	moveq #0,d1
	move.b (a0)+,d1
	mulu #BLOCK_WIDTH*BLOCK_Y*BPL_DEPTH,d1
	lea 0(a2,d1.l),a3
