...
*			Cube en 3d avec des Chess Board dessus
*			~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Flip_Screen
	...
	move.l #(SCREEN_HEIGHT<<17)|(SCREEN_WIDTH/16),bltsizV(a6)
	rts
...
DOT	macro
	...
	endm
Dots_3d
	DOT DIST,DIST,DIST			point 0
	DOT DIST,-DIST,DIST			point 1
	DOT -DIST,-DIST,DIST
	DOT -DIST,DIST,DIST
	DOT DIST,DIST,-DIST
	DOT DIST,-DIST,-DIST
	DOT -DIST,-DIST,-DIST
	DOT -DIST,DIST,-DIST			point 7
...
coplist
	...
	section ecran,bss_c
screen1
	ds.b (SCREEN_WIDTH/8)*SCREEN_HEIGHT*NB_BPL+8
screen2
	ds.b (SCREEN_WIDTH/8)*SCREEN_HEIGHT*NB_BPL+8
