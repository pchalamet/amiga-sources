...
mt_SetCIAInt
	MOVEQ	#2,D6
	LEA	$BFD000,A5
	MOVE.B	#'b',mt_CIAAname+3
SetCIALoop
	MOVEQ	#0,D0
	LEA	mt_CIAAname(PC),A1
	MOVE.L	(_SysBase).W,A6
	JSR	_LVOOpenResource(A6)
	MOVE.L	D0,CIAAbase
	BEQ.S	mt_CiaError

	LEA	mt_GfxName(PC),A1
	MOVEQ	#0,D0
...
mt_CIAAname	dc.b "ciab.resource",0
mt_GfxName	dc.b "graphics.library",0
mt_musintname	dc.b "Protracker MusicInt",0
