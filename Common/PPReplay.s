*********************************************************************
*                                                                   *
*                 ннн Enlightment greetingspart ннн                 *
*                                                                   *
* By: Azatoth of Phenomena.		      Last change: 19-11-91 *
*                                                                   *
*********************************************************************

******************** Defines Structures n Macros ********************

ScrDepth	EQU	1		Vector screen defines
ScrHeight	EQU	256
ScrBPR		EQU	40
ScrBPB		EQU	ScrBPR*ScrHeight
ScrBytes	EQU	ScrDepth*ScrBPB

		include Include:StdMacros.s

******************************** Main *******************************

Start		lea	$dff000,a6		Init
		mac	SystemOff
		icpr	ScrAdr,ScrBplPtrs,ScrDepth,ScrBPB
		move.l	#CprList,$080(a6)
		move	#$83c0,$096(a6)
		move	#$c000,$09a(a6)
...
CprList		dc.w	$0102,$0000
		dc.w	$0104,$0000
		dc.w	$008e,$2c81
		dc.w	$0090,$2cc1

		dc.w	$0100,$0200+ScrDepth*4096
		dc.w	$0092,$0038
		dc.w	$0094,$00d0
		dc.w	$0108,ScrBPR-40
		dc.w	$010a,ScrBPR-40
ScrBplPtrs	ds.w	4*ScrDepth
ScrColors	dc.w	$0180,$0000,$0182,$0001,$0184,$0002,$0186,$0003
		dc.w	$0188,$0004,$018a,$0005,$018c,$0006,$018e,$0007
		dc.w	$0190,$0008,$0192,$0009,$0194,$000a,$0196,$000b
		dc.w	$0198,$000c,$019a,$000d,$019c,$000e,$019e,$000f
		dc.w	$01a0,$011f,$01a2,$022f,$01a4,$033f,$01a6,$044f
		dc.w	$01a8,$055f,$01aa,$066f,$01ac,$077f,$01ae,$088f
		dc.w	$01b0,$099f,$01b2,$0aaf,$01b4,$0bbf,$01b6,$0ccf
		dc.w	$01b8,$0ddf,$01ba,$0eef,$01bc,$0fff,$01be,$0fff
...
pp_DmaIrq	tst.b	$bfdd00
		...
		move	pp_DmaconTemp(pc),$dff096
		move	#$2000,$dff09c
		rte

pp_RegIrq	tst.b	$bfdd00
		sub.l	#pp_RegIrq-pp_DmaIrq,$78.w
		move.l	pp_Chn1Struct+pc_LoopStart(pc),$dff0a0
		move.l	pp_Chn2Struct+pc_LoopStart(pc),$dff0b0
		move.l	pp_Chn3Struct+pc_LoopStart(pc),$dff0c0
		move.l	pp_Chn4Struct+pc_LoopStart(pc),$dff0d0
		move	pp_Chn1Struct+pc_RepLen(pc),$dff0a4
		move	pp_Chn2Struct+pc_RepLen(pc),$dff0b4
		move	pp_Chn3Struct+pc_RepLen(pc),$dff0c4
		move	pp_Chn4Struct+pc_RepLen(pc),$dff0d4
		move	#$2000,$dff09c
		rte
...
pp_Data		Place propacked module here

******************* End of ProPacker routines ***********************
*********************************************************************

ScrAdr		dcb.b	ScrBytes
